import json
import logging
from bitbucket import BitbucketCreateRepository

logger = logging.getLogger()
myFormatter = logging.Formatter('[BITBUCKET CREATE REPO ACTION] >> %(message)s')
...
def run(metadata):
    create_repo = BitbucketCreateRepository(**metadata.inputs)
